...
const Projects = () => {
  ...
  return (
    <section data-aos="fade-right"  className={`h-screen border-t-4 border-gray-200 md:px-28 lg:px-32  px-8 lg:flex lg:flex-row section bg-bg text-content`}>
        <div className=''>
            <img src="/src/assets/Ideas to Projects.png" className=' mx-2 mt-96 rotate-12 hidden lg:block lg:dark:hidden' alt="logo" width="300px"/>
            <img src="/src/assets/Ideas to Projects Light.png" className=' mx-2 mt-96 rotate-12 hidden lg:hidden lg:dark:block' alt="logo" width="300px"/>
        </div>
