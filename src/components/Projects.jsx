  ...
  return (
    <section data-aos="fade-right"  className={`h-screen border-t-4 border-gray-200 md:px-28 lg:px-32 gap-6  px-8 lg:flex lg:flex-row section bg-bg text-content relative`}>
        <div className='flex flex-col gap-0'>
          ...
          <div className=''>
            <img src="/src/assets/Ideas to Projects.png" className=' mx-2 mt-96 rotate-12 hidden lg:block lg:dark:hidden' alt="logo" width="500px"/>
            <img src="/src/assets/Ideas to Projects Light.png" className=' mx-2 mt-96 rotate-12 hidden lg:hidden lg:dark:block' alt="logo" width="500px"/>
          </div>
        </div>
