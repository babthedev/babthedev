...
const About = () => {
  return (
    <section data-aos="fade-up" className='h-screen border-t-4 px-8 md:px-20 lg:px-28 xl:px-32 border-gray-200 section bg-bg text-content' id='about'>
        <div className='flex flex-col lg:flex-row lg:gap-32'>
        <div className="lg:flex flex-col mt-6 lg:mt-16 ">
         <div className=' px-6 lg:mb-20 mb-6 ml-auto '>
         ...
         <div className=' px-6 py-0 lg:mb-3 mb-6 ml-auto lg:ml-0 '>
        ...
        <div className="lg:flex flex-col mb-6 lg:mb-20 ">
